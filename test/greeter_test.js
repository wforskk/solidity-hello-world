...
contract("Greeter", (accounts) => {
    it("has been deployed successfull", async () => {
        const greeter = await GreeterContract.deployed();
        assert(greeter, "contract was not deploy")
    })
    describe("greet()", () => {
    ...
    describe("owner()", () => {
        ...
        it("matches the address that originally deployed the contract", async () => {
            ...
            assert.equal(owner, expected, "mathches address used to deploy contract");
        });
    });
});
...
contract("Greeter: update greeting", (accounts) => {
    describe("setGreeting(string)", () => {
        ...
        describe("when message is sent by another owner", () => {
            it("does not set the greeting", async () => {
                ...
                assert.equal(false, "greeting should not update");
            });
        });
        it("sets greeting to passed in string", async () => {
            const greeter = await GreeterContract.deployed();
